...
vector_init=function(n) {  #Infecteaza random un calculator din retea
...
#functia numara calculatoarele infectate
...
#functia curata k calculatoare infectate
